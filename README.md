...
| `RELAY_HOST`                    | relay | Interface the relay binds to (default `0.0.0.0`). Behind a reverse proxy or tunnel, set `127.0.0.1`: the `Origin` allow-list is a browser guarantee and a non-browser client can forge that header.                                    |
